...
#define UI_STYLE_BACKGROUNDFILL		53, 86, 117, 255	
#define UI_STYLE_HIGHLIGHTS			97, 210, 255, 255	

#define UI_STYLE_BUTTON_OUTLINE		78, 94, 110, 255		
#define UI_STYLE_BUTTON_ARMED		20, 59, 96, 255		
#define UI_STYLE_BUTTON_ENABLED		24, 43, 66, 255		
#define UI_STYLE_BUTTON_BACKGROUND	65, 78, 91, 255		
#define UI_STYLE_BUTTON_CENTER		28, 80, 130, 255	 

#define UI_STYLE_NB_TITLE_MEDIUM	47, 79, 111, 255

#define UI_STYLE_FOOTER_GRADIENT	19, 35, 65, 255		
#define UI_STYLE_FOOTER_GRALINE		35, 61, 87, 255		
